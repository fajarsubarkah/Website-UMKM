...
<body>
    ...
    <header class="header-absolute">
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-lg-12">
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item mr-2"><i class="fas fa-phone"></i> +62 852-6311-0381</li>
                            <li class="list-inline-item border-left px-3 d-none d-sm-inline"> Free Shipping on orders
                                over <i class="fa-solid fa-rupiah-sign"></i>Rp300000</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <!-- Nav bar -->
        <nav class="navbar navbar-expand-lg navbar-light navbar-airy fixed-top py-lg-4 px-lg-5 text-uppercase mb-5"
            id="mainNav" data-toggle="affix">
            <div class="container-fluid" id="main-navbar">
                <a class="navbar-brand" href="<?php echo base_url(); ?>">D'THRIFT.</a>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="sub-menu">
                                <ul class="list-unstyled list-inline">
                                    <li><a href="<?php echo base_url() . 'category/women/ethnic'; ?>">Ethnic Wear</a>
                                    </li>
                                    <li><a href="<?php echo base_url() . 'category/women/western'; ?>">Western Wear</a>
                                    </li>
                                    <li><a href="<?php echo base_url() . 'category/women/formal'; ?>">Formal Wear</a>
                                    </li>
                                    <li><a href="<?php echo base_url() . 'category/women/winter'; ?>">Winter Wear</a>
                                    </li>
                                </ul>
                            </div>
                            <!-- <div class="dropdown">
                ...
                <li class="dropdown-item">Formal Dresses</li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="sub-menu">
                                <ul class="list-unstyled list-inline">
                                    <li><a href="<?php echo base_url() . 'category/men/ethnic'; ?>">Casual Wear</a></li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo base_url() . 'shop/about'; ?>">About</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content" id="login">
                ...
                <form action="#" method="post">
                    ...
                    <div class="modal-body mx-4">
                        ...
                        <div class="row my-3 d-flex justify-content-center">
                            <!--Facebook-->
                            <button type="button" class="btn btn-white mr-3 z-depth-1a"><i
                ...
                <div class="modal-footer pt-3 mb-1">
                    <p class="font-small grey-text d-flex justify-content-end">Not a member? <a href="#registerButton"
                            id="registerButton" class="blue-text ml-1">
                            Register</a></p>
                </div>
            </div>
            <!--/.Content-->
            ...
            <div class="modal-content d-none" id="register">
                ...
                <form method="post" action="#" id="registration">
                    ...
                    <div class="modal-body mx-4">
                        ...
                        <div class="mb-3">
                            ...
                            <label data-error="wrong" data-success="right" for="Form-email1">Email&nbsp;/&nbsp;Mobile
                                No.</label>
                            <input type="text" id="regInput" name="regInput" class="form-control" required
                                minlength="10">
                ...
                <li>Please Enter A Valid Email Address</li>
                        ...
                        <div class="pb-3">
                            ...
                            <input type="password" id="regPass" name="regPass" class="form-control" minlength="8"
                        ...
                        <div class="pb-3">
                            ...
                            <input type="password" id="regPass2" name="regPass2" class="form-control" minlength="8"
                                maxlength="50" required>
                        </div>
                ...
                <!--Footer-->
                <div class="modal-footer pt-3 mb-1">
                    <p class="font-small grey-text d-flex justify-content-end">Already a member? <a href="#loginButton"
                            class="blue-text ml-1" id="loginButton">
                            Login</a></p>
                </div>
            </div>
