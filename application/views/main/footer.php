            ...
            <div class="row">
                <div class="col-lg-4 service-column">
                    ...
                    <div class="services">
                        ...
                        <p class="text-muted">Free Shipping over <i class="fa-solid fa-rupiah-sign"></i>Rp10000</p>
                    </div>
                </div>
                <div class="col-lg-4 service-column">
                    <div class="service-icon">
                ...
                <div class="col-lg-4 service-column">
                    ...
                    <div class="services">
                        <h6 class="text-uppercase">+62 852-6311-0381</h6>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 my-5">
                    ...
                    <p class="mb-3"> To get daily offers and discounts, subscribe to our newsletter.</p>
                    <form action="#" id="newsletter-form">
                        <div class="input-group mb-3">
                            <input type="email" placeholder="Your Email Address" aria-label="Your Email Address"
                                class="form-control bg-transparent border-secondary border-right-0 rounded-0">
                            <div class="input-group-append">
                                <button type="submit" class="btn btn-outline-secondary border-left-0 rounded-0"> <i
        ...
        <div class="container">
            <div class="row">
                <div class="text-white text-center">
                    <p class="mb-md-0" style="letter-spacing: 3px;">&copy; 2021 D'THRIFT. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
