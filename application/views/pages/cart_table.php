...
<div class="row">
    <div class="col-xl-8 offset-xl-2 text-center mb-5">
        <p class="lead text-muted">You have <?php echo $total; ?> items in your shopping cart</p>
    </div>
</div>
                                ...
                                <div class="col-12 col-md-7 mt-4 mt-md-0">
                                    <div class="row align-items-center">
                                        <div class="col-md-3">
                                            <div class="row">
                                                ...
                                                <div class="col-6 col-md-12 text-right text-md-center" id="price"><i
                                                        class="fas fa-rupiah-sign">Rp&nbsp;</i><?php echo $product['price']; ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-2 d-none d-md-block text-center">
                                            <a href="<?php echo base_url() . 'shopping/deleteItem?id=' . $product['pid'] . '&size=' . $product['size']; ?>"
                                                class="cart-remove">
