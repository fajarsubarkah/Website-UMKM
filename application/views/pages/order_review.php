...
<div class="row">
    <div class="col-xl-8 offset-xl-2 text-center mb-5">
        <p class="lead text-muted">Please review your cart.</p>
    </div>
</div>
        ...
        <div class="row mb-5">
            <div class="col-lg-8">
                ...
                <ul class="custom-nav nav nav-pills mb-5">
                    <li class="nav-item w-25"><a href="<?php echo base_url('shopping/getAddress'); ?>"
                    ...
                    <li class="nav-item w-25"><a href="<?php echo base_url('shopping/paymentMethod'); ?>"
                            class="nav-link text-sm">Payment Method </a></li>
                                ...
                                <div class="col-12 col-md-5">
                                    <div class="d-flex align-items-center">
                                        <a href="<?php echo base_url() . 'product/index/' . $product['pid']; ?>">
                                            <img src="<?php echo base_url() . 'assets/img/' . $product['pimage']; ?>"
                                                class="cart-item-img">
                                        </a>
                                        <div class="cart-title text-left">
                                            <a href="<?php echo base_url() . 'product/index/' . $product['pid']; ?>"
                                                class="text-uppercase text-dark"><strong><?php echo ucfirst($product['category']) . " " . $product['pname']; ?></strong></a>
                                            <br>
                                            <span class="text-muted text-sm">Size:
                                                <?php echo strtoupper($product['size']); ?></span>
                                            <br>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="col-6 col-md-12 text-right text-md-center" id="price"><i
                                                        class="fas fa-rupiah-sign">Rp&nbsp;
                                                    </i><?php echo number_format($product['price'], 0, ',', '.'); ?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-6 col-md-12 text-right text-md-center" id="totalPrice">
                ...
                <div class=" mb-5 d-flex justify-content-between flex-column flex-lg-row">
                    <a href="<?php echo base_url('shopping/paymentMethod');  ?>"
                        class="btn btn-link text-muted text-capitalize">
                        <i class="fas fa-arrow-left"></i>&nbsp;Payment Method
                    </a>
                    <a href="<?php echo base_url('shopping/confirmOrder');  ?>"
                        class="btn btn-outline-dark text-capitalize" name="confirmOrder">Place an Order&nbsp;<i
