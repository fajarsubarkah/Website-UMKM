    ...
    <div class="container">
        <ol class="breadcrumb justify-content-center">
            ...
            <li class="breadcrumb-item"><a
                    href="<?php echo base_url() . 'category/' . $product['gender'] . '/' . $product['category']; ?>"><?php echo ucfirst($product['category']); ?></a>
            </li>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="mt-4 mb-3">
                    <!--  product Price -->
                    <h1>Rp</i>
                        <?php echo number_format($product['price'], 0, ',', '.'); ?></h1>
                    <p id="discount-display">
                        <span class="text-success font-weight-bold h3">52% OFF</span>
                    </p>
                ...
                <?php if (in_array('xl', $sizeArr, true)) {
                    echo "";
                } else {
                    echo "disabled";
                } ?>">
                ...
                <?php if (in_array('l', $sizeArr, true)) {
                    echo "";
                } else {
                    echo "disabled";
                } ?> ">
                ...
                <?php if (in_array('m', $sizeArr, true)) {
                    echo "";
                } else {
                    echo "disabled";
                } ?> ">
                ...
                <?php if (in_array('s', $sizeArr, true)) {
                    echo "";
                } else {
                    echo "disabled";
                } ?> ">
                ...
                <?php if (in_array('xs', $sizeArr, true)) {
                    echo "";
                } else {
                    echo "disabled";
                } ?> ">
                    ...
                    <div>
                        <button type="submit" class="btn btn-lg btn-outline-dark text-uppercase mt-5" id="addToCart"><i
