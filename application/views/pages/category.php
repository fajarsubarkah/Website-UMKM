                        ...
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
                            <div class="card-body category-list categoryFilter">
                                <ul class="list-unstyled">
                                    ...
                                    ?>
                                    <li>
                                        <input class="styled-checkbox sub-category"
                                            id="<?php echo $category['subcategory']; ?>" type="checkbox"
                                            value="<?php echo $category['subcategory']; ?>">
                                        <label for="<?php echo $category['subcategory']; ?>">
                                            <?php echo $category['subcategory']; ?></label>
                                    </li>
                    ...
                    <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo">
                            <div class="card-body category-list">
                                <ul class="list-unstyled">
                                    <li>
                                        <input class="styled-checkbox check-size" id="X-Small" type="checkbox"
                                            value="xs">
                                    ...
                                    <li>
                                        <input class="styled-checkbox check-size" id="X-Large" type="checkbox"
                                            value="xl">
                        ...
                        <div class="card-body category-list mt-3">
                            ...
                            <div id="priceFilterMenu">
                                ...
                                <div class="nouislider-values">
                                    <div class="min">From <i class="fas fa-rupiah-sign">Rp</i><span
                                            id="slider-snap-value-lower"></span></div>
                                    <div class="max">To <i class="fas fa-rupiah-sign">Rp</i><span
                                            id="slider-snap-value-upper"></span></div>
                                    <input type="hidden" name="pricefrom" id="slider-snap-input-lower" value="100"
                                        class="slider-snap-input">
                                    <input type="hidden" name="priceto" id="slider-snap-input-upper" value="10000"
                                        class="slider-snap-input">
                                </div>
                            </div>
                            ...
                            <div class="card-body colorFilter">
                                <ul class="list-inline colours-wrapper">
                                    ...
                                    <li class="list-inline-item">
                                        <label for="<?php echo $colorList['color']; ?>" class="btn-colour"
                                            data-allow-multiple
                                            style="background-color:<?php echo $colorList['color']; ?>"></label>
                                        <input id="<?php echo $colorList['color']; ?>" type="checkbox"
                                            value="<?php echo $colorList['color']; ?>"
                                            class="input-invisible color styled-checkbox">
                                    </li>
                ...
                <div class="row mt-3 py-3 mb-5" id="ajaxData">
                    ...
                    <div class="col-lg-4 my-4">
                        <div class="product-image">
                            <img src="<?php echo base_url() . 'assets/img/' . $lists['pimage']; ?> "
                                class="pimage img-fluid">
                            <div class="product-hover-overlay">
                                <a href="<?php echo base_url() . 'product/index/' . $id; ?>"
                                    class="product-hover-overlay-link"></a>
                                <div class="product-hover-overlay-buttons">

                                    <a href="<?php echo base_url() . 'product/index/' . $id; ?>"
                                        class="btn btn-outline-dark btn-buy"><i class="fa-search fa"></i>
                                        <span>View</span>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="py-2">
                            ...
                            </h3><span class="text-dark"><i class="fas fa-rupiah-sign">Rp&nbsp;
                                </i><?php echo number_format($lists['price'], 0, ',', '.'); ?></span>
                        </div>
                    </div>
